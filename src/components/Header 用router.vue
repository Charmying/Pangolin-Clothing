                        ...
                        <ul>
                            <li class="box-distance">
                                ...
                                <ul class="header-options">
                                    <li><router-link to="NewArrivals">最新商品</router-link></li>
                                    <li><router-link to="Commodity">精選商品</router-link></li>
                                    <li><router-link to="OnSale">特價商品</router-link></li>
                                    <li><router-link to="Co-Branding">聯名商品</router-link></li>
                                </ul>
                            </li>
                            <li class="box-distance">
                                <router-link to="News">
                                ...
                                <!-- <ul class="header-options">
                                    ...
                                    <li><router-link to="#">精選商品</router-link></li>
                                    <li><router-link to="#">特價商品</router-link></li>
                                    <li><router-link to="#">聯名商品</router-link></li>
                                </ul> -->
                            </li>
                            <li class="box-distance">
                                <div class="header-title">
                                ...
                                <span class="header-underline"></span>
                                <ul class="header-options">
                                    <li><router-link to="AboutUs">品牌故事</router-link></li>
                                    <li><router-link to="Shop">實體通路</router-link></li>
                                    <li><router-link to="Recruit">人才招募</router-link></li>
